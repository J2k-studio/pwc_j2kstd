...
/* Builds the full colored prompt string.
 * Style: PowerShell-inspired  PS <path>>
 * Path in bright cyan, "PS" in blue, trailing > in white. */
static void build_prompt(char *out, size_t out_size) {
    char shortpath[PATH_MAX];
    short_prompt_path(shortpath, sizeof(shortpath));
    snprintf(out, out_size,
             "\033[38;2;0;122;204mPS "
             "\033[38;2;78;201;176m%s"
             "\033[0m> ",
             shortpath);
}
